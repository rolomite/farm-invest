<x-app-layout>
    <section class="banner-section">
        ...
        <div class="hero-wrapper-one gray-bg">
            <div class="shape shape-one animate-float-y"><span><img src="assets/images/hero/shape-1.png"
                                                                    alt="shape"></span></div>
            <div class="shape shape-two animate-float-x"><span><img src="assets/images/hero/shape-2.png"
                                                                    alt="shape"></span></div>
            <div class="shape shape-three animate-float-x"><span><img src="assets/images/hero/shape-3.png" alt="shape"></span>
            </div>
            <div class="container">
                <div class="row align-items-lg-center">
                    <div class="col-xl-6 col-lg-12">
                        ...
                        <div class="hero-content">
                            <h1 class="wow fadeInUp" data-wow-delay=".4s">Sow the Seeds of Wealth
                                with {{ config('app.name') }}</h1>
                            <p class="wow fadeInDown" data-wow-delay=".6s">Empower sustainable farming while growing
                                your wealth. Join us in shaping the future of the cocoa industry, one investment at a
                                time.</p>
                    ...
                    <div class="row align-items-xl-center">
                        ...
                        <div class="col-xl-7 col-lg-12">
                            ...
                            <div class="about-three_content-box pl-lg-70 wow fadeInRight">
                                ...
                                <p class="mb-40 wow fadeInDown">At {{ config('app.name') }}, we combine ethical
                                    investment opportunities with sustainable cocoa farming to empower local farmers,
                                    promote environmental stewardship, and deliver solid returns to our investors. Join
                                    us as we reshape the future of cocoa farming.</p>
                                <div class="row">
                                    <div class="col-sm-6">
                                        <!--=== Fancy About Item ===-->
                                        <div class="fancy-about-item mb-40 wow fadeInUp">
                                            <div class="text">
                                                <h5><i class="far fa-angle-double-right"></i>Sustainable Farming
                                                    Practices</h5>
                                                <p>We promote eco-friendly farming methods that protect the environment
                                                    and ensure long-term crop productivity.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fancy-about-item mb-40 wow fadeInDown">
                                            <div class="text">
                                                ...
                                                <p>We equip farmers with training and resources to boost productivity
                                                    and improve their livelihoods.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fancy-about-item mb-40 wow fadeInUp">
                                            <div class="text">
                                                <h5><i class="far fa-angle-double-right"></i>Transparent Investment
                                                    Process</h5>
                                                <p>Track your investments in real-time with complete transparency on
                                                    fund allocation and progress.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                        ...
                                        <div class="fancy-about-item mb-40 wow fadeInUp">
                                            <div class="text">
                                                <h5><i class="far fa-angle-double-right"></i>Positive Environmental
                                                    Impact</h5>
                                                <p>A portion of every investment supports reforestation and eco-friendly
                                                    farming initiatives.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="single-service-item-two mb-80 wow fadeInDown" data-wow-delay=".2s">
                        ...
                        <div class="text">
                            ...
                            <p>Our focus is on producing high-quality cocoa through ethical practices that benefit both
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="single-service-item-two mb-80 wow fadeInUp" data-wow-delay=".25s">
                        ...
                        <div class="text">
                            ...
                            <p>We bridge the gap between farmers and international markets, ensuring fair trade
                                practices and better pricing for their products</p>
                            <a href="#" class="icon-btn"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="single-service-item-two mb-80 wow fadeInDown" data-wow-delay=".3s">
                        ...
                        <div class="text">
                            ...
                            <p>We implement modern farming tools, data-driven strategies, and advanced techniques to
                                optimize yields and improve efficiency.</p>
                            <a href="#" class="icon-btn"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="single-service-item-two mb-80 wow fadeInUp" data-wow-delay=".35s">
                        ...
                        <div class="text">
                            ...
                            <p>We manage and support cocoa farms using eco-friendly methods that enhance soil fertility,
                                conserve resources, and ensure long-term productivity.</p>
                            <a href="#" class="icon-btn"><i class="fal fa-long-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="testimonial-inner-content mb-30">
                                                ...
                                                <div class="quote-title">
                                                    ...
                                                    <div class="title">
                                                        ...
                                                        <p class="position">{{ $testimony->title }}</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="testimonial-author mb-30">
                                                <img src="{{ asset($testimony->image) }}" class="rounded-circle" alt="testimonial image">
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
